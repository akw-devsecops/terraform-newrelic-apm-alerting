...
variable "synthetics_monitor_public_locations" {
  description = "The locations to run synthetics checks from. Valid values are AP_EAST_1, AP_SOUTH_1, AP_SOUTHEAST_1, AP_NORTHEAST_2, AP_NORTHEAST_1, AP_SOUTHEAST_2, US_WEST_1, US_WEST_2, US_EAST_2, US_EAST_1, CA_CENTRAL_1, SA_EAST_1, EU_WEST_1, EU_WEST_2, EU_WEST_3, EU_CENTRAL_1, EU_NORTH_1, EU_SOUTH_1, ME_SOUTH_1, or AF_SOUTH_1"
  type        = list(string)
